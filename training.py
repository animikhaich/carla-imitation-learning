...
def train(data_folder, labels_path, save_path):
    """
    ...
    train_loader = get_dataloader(data_folder, labels_path, batch_size)
...
if __name__ == "__main__":
    ...
    parser.add_argument('-l', '--labels_path', default="./data/metrics/metrics.csv", type=str, help='path to where you save the labels you collect')
    parser.add_argument('-s', '--save_path', default="./", type=str, help='path where to save your model in .pth format')
    args = parser.parse_args()
    
    train(args.data_folder, args.labels_path, args.save_path)