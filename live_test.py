...
class CameraManager(object):
    def __init__(self, parent_actor, hud, gamma_correction, world=None):
        ...
        self.model.load_state_dict(torch.load(f"small_v1_best.pt").state_dict())
    ...
    def _parse_image(weak_self, image):
        ...
        if self.sensors[self.index][0].startswith('sensor.lidar'):
            ...
            self.world.player.apply_control(carla.VehicleControl(steer=steer, throttle=throttle, brake=brake))
